...
function ciniki_events_priceAdd(&$ciniki) {
    ...
    $rc = ciniki_events_checkAccess($ciniki, $args['business_id'], 'ciniki.events.priceAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
	...
	return ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.events.price', $args);
}
?>
